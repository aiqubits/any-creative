...
export const models: Models = {
    ...
    [ModelProviderName.GOOGLE]: {
        ...
        endpoint: "https://quiet-malabi-442620.netlify.app",
        model: {
            [ModelClass.SMALL]: {
                name:
    ...
    [ModelProviderName.ZEROG_COMPUTE]: {
        endpoint: settings.ZEROG_EVM_RPC || "https://evmrpc-testnet.0g.ai",
        model: {
            [ModelClass.SMALL]: {
                name:
                    settings.SMALL_ZEROG_COMPUTE_MODEL ||
                    settings.ZEROG_COMPUTE_MODEL ||
            ...
            [ModelClass.MEDIUM]: {
                name:
                    settings.MEDIUM_ZEROG_COMPUTE_MODEL ||
                    settings.ZEROG_COMPUTE_MODEL ||
                    "llama-3.3-70b-instruct",
                stop: [],
                maxInputTokens: 128000,
            ...
            [ModelClass.LARGE]: {
                name:
                    settings.LARGE_ZEROG_COMPUTE_MODEL ||
                    settings.ZEROG_COMPUTE_MODEL ||
                    "deepseek-r1-70b",
                stop: [],
                maxInputTokens: 128000,
            ...
            [ModelClass.IMAGE]: {
                name: settings.IMAGE_ZEROG_COMPUTE_MODEL || "fireworks::accounts/fireworks/models/playground-v2-5-1024px-aesthetic",
            },
        },
    },
};
